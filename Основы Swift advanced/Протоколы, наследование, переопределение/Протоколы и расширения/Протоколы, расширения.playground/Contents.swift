...
protocol Dealership {
    ...
    func fromStockToShowroom(car: CarProtocol) //метод, позволяющий перегнать авто из склада в шоурум (для полноты картины :) )
}
...
print("------------------Volvo------------------")
var volvoCar1: CarProtocol = ModelCar(model: "XC90", color: "White", buildDate: 2020, price: 34522, accessories: [], isServiced: false, vin: 5234567890)
...
print("------------------Honda------------------")
var hondaCar1: CarProtocol = ModelCar(model: "Civic", color: "White", buildDate: 2020, price: 34522, accessories: [], isServiced: false, vin: 5234567890)
...
print("------------------Lexus------------------")
var lexusCar1: CarProtocol = ModelCar(model: "LX570", color: "White", buildDate: 2020, price: 34522, accessories: [], isServiced: false, vin: 5234567890)
...
let lexusDealer = Dealer(showroomCapacity: 5, name: "Lexus")
...
extension Dealer {
    func checkCarsForSpessialOffer(stock: [CarProtocol], showroom: [CarProtocol]) {
...
print("------------------Part 4------------------")
lexusDealer.orderCar(car: bmwCar1)
lexusDealer.orderCar(car: volvoCar1)
lexusDealer.orderCar(car: audiCar1)
lexusDealer.orderCar(car: hondaCar1)
lexusDealer.checkCarsForSpessialOffer(stock: lexusDealer.stockCars, showroom: lexusDealer.showroomCars)
